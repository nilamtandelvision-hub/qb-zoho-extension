...
<body>
  <div class="card">
    <div class="header">
      ...
      <p>One-time setup. Connect both accounts to enable syncing.</p>
    </div>
    ...
    <div class="note">
      ...
      Open the <strong>QuickBooks Sync widget</strong> inside Zoho CRM to sync your customers and invoices.
      This page is for one-time setup only — all sync buttons are in the widget.
    </div>
  </div>
</body>
</html>`);
